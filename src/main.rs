...
fn main() {
    ...
    let output: i32 = match (day, part) {
        ...
        (9, 1) => day_9_part_1(input),
        (9, 2) => day_9_part_2(input),
...
fn day_8_part_1(_: String) -> i32 {
    0
}

fn day_8_part_2(_: String) -> i32 {
    0
}


fn day_9_part_1(_: String) -> i32 {
    0
}

fn day_9_part_2(_: String) -> i32 {
    0
}
